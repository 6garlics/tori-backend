...
public class LetterService {
    ...
    public LetterList<LetterResponseByBook> listByBook(String userName, Long bookId){
        ...
        List<LetterResponseByBook> letters = letterRepository.findAllByBook(target);
        return new LetterList<LetterResponseByBook>(letters);
    }
    */
    ...
    public LetterList<LetterResponseByUser> listByUser(String userName){
        ...
        //LetterList<LetterResponseByUser> response = new LetterList<>();
